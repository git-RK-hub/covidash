...
var stateCoordinatesIndia = JSON.parse(document.getElementById("map").dataset.coordinates);
mapboxgl.accessToken = "pk.eyJ1IjoicmlzaGkzcGIyIiwiYSI6ImNrZGVja2dsNjIyM2Iycms2MWZ3Nmg5M2MifQ.VDpoOSmGxEpj2nLJu0rLBw";
...
function mapEffect() {
  return _mapEffect.apply(this, arguments);
}

function _mapEffect() {
  _mapEffect = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var countryResult, stateResultIndia, countryLocations, stateInfoIndia;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("https://corona.lmao.ninja/v2/countries");

          case 3:
            countryResult = _context.sent;
            _context.next = 6;
            return _axios.default.get("https://api.covidindiatracker.com/state_data.json");

          case 6:
            stateResultIndia = _context.sent;
            _context.next = 12;
            break;
          ...
          case 9:
            ...
            console.log("Failed to fetch countries: ".concat(_context.t0.message), _context.t0);

          case 12:
            countryLocations = countryResult.data.map(function (el) {
              var obj = {
                coordinates: {
            ...
            stateInfoIndia = stateResultIndia.data.map(function (el) {
              var obj = {
                coordinates: stateCoordinatesIndia.filter(function (l) {
            ...
            stateInfoIndia.forEach(function (e) {
              var el = document.createElement("div");
              el.className = "marker2";
              var markup = "<div>\n      <span style=\"color: blue; font-family: cursive; font-size: 14px; font-weight: 600;\">State:</span> ".concat(e.info.state, "</br>\n      <span style=\"color: brown; font-family: cursive; font-size: 14px; font-weight: 600;\">Total Cases:</span> ").concat(e.info.totalCases, "</br>\n      <span style=\"color: red; font-family: cursive; font-size: 14px; font-weight: 600;\">Active Cases:</span> ").concat(e.info.activeCases, "</br>\n      <span style=\"color: green; font-family: cursive; font-size: 14px; font-weight: 600;\">Recoverd Cases:</span> ").concat(e.info.recoveredCases, "</br>\n      <span style=\"color: purple; font-family: cursive; font-size: 14px; font-weight: 600;\">Deaths:</span> ").concat(e.info.totalDeaths, "</br>\n    </div>");
              var lnglat = e.coordinates[0].cordinates;
              var popup = new mapboxgl.Popup({
                offset: 10
              }).setLngLat(lnglat).setHTML(markup);
              new mapboxgl.Marker({
                element: el,
                anchor: "bottom"
              }).setLngLat(lnglat).setPopup(popup).addTo(map);
            });
            countryLocations.forEach(function (loc) {
              var el = document.createElement("div");
              el.className = "marker";
              var markup = "<div>\n      <span style=\"color: blue; font-family: cursive; font-size: 14px; font-weight: 600;\">Country:</span> ".concat(loc.info.country, "</br>\n      <span style=\"color: brown; font-family: cursive; font-size: 14px; font-weight: 600;\">Total Cases:</span> ").concat(loc.info.totalCases, "</br>\n      <span style=\"color: red; font-family: cursive; font-size: 14px; font-weight: 600;\">Active Cases:</span> ").concat(loc.info.activeCases, "</br>\n      <span style=\"color: green; font-family: cursive; font-size: 14px; font-weight: 600;\">Recoverd Cases:</span> ").concat(loc.info.recoveredCases, "</br>\n      <span style=\"color: orange; font-family: cursive; font-size: 14px; font-weight: 600;\">Critical cases:</span> ").concat(loc.info.criticalCases, "</br>\n      <span style=\"color: purple; font-family: cursive; font-size: 14px; font-weight: 600;\">Deaths:</span> ").concat(loc.info.totalDeaths, "</br>\n    </div>");
              var popup = new mapboxgl.Popup({
                offset: 10
              }).setLngLat(loc.coordinates).setHTML(markup);
              new mapboxgl.Marker({
                element: el,
                anchor: "bottom"
